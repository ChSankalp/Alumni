...
class _StudentPageState extends State<StudentPage> with SingleTickerProviderStateMixin{
  ...
  String propicUrl = LoginCreds().url+"pro_pics/propic.jpg";
        ...
        backgroundColor: actualWhite,
          ...
          iconTheme: IconThemeData(color: Colors.black,),
            ...
            Visibility(
              ...
              child: IconButton(
                  icon: Icon(Icons.find_in_page, color: actualBlack,),
                  onPressed: ()async{
                    await showDialog(
                        context: context,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                visible: !(this.cats.length==1 && this.cats[0]=="all"),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: Tags(
                    ...
                    itemBuilder: (int index1){
                      return ItemTags(
                        key: Key(index1.toString()),
                        index: index1,
                        title: this.cats[index1],
